...
export interface InitOutput {
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h53f1264f8f163479: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h5e60aa2a63694ecb: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h3a2422453d417b6c: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__ha45c7b353a19e2d7: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h80cc66eeffe3adfd: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__he10950d108af5595: (a: number, b: number) => number;
    readonly wasm_bindgen__convert__closures_____invoke__h279f8cb795e90bf4: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hdcc83c68c760386c: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h6605c89fec14e8ba: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h1035a2e3096eef65: (a: number, b: number) => void;
